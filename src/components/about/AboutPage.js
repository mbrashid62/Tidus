  ...
  render() {
    ...
    <div className="container-fluid">
        <div className="jumbotron">
            ...
            <p>You may know that Spotify offers a variety of data accessiblethrough their public and private APIs.</p>
            <p>This app used the Spotify API to connect your account and fetch your playlists.</p>
